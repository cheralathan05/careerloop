// client/src/pages/auth/Login.jsx (ULTIMATE FINAL VERSION)
...
// Custom Hook for Reduced Motion (Accessibility)
...
      staggerChildren: 0.1, // Adjusted stagger
      delayChildren: 0.3,
    },
  },
  exit: {
...
    boxShadow: '0 8px 20px rgba(99, 102, 241, 0.25)', // Soft shadow glow
...
// --- Particle Component (Background Visuals) ---
...
  const [isSubmitting, setIsSubmitting] = useState(false); // Demo state
...
      
      {/* Animated Background Particles (Only enabled if motion is preferred) */}
...
            className="space-y-6"
            // If motion is reduced, use a simple variant to ensure rendering
            variants={!prefersReducedMotion ? containerVariants : { visible: { opacity: 1 } }}
            initial="hidden"
            animate="visible"
            exit="exit"
          >
            {/* AuthForm - Cascading Animation */}
...
            </motion.div>
            
            {/* Google Button - With Hover/Tap Feedback */}
            <motion.div variants={itemVariants}>
              <motion.div
